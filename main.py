...
# from BanknoteOptimizer import BanknoteOptimizer  ### They are classes in themselves!
...
def train_banknot():
    ...
    # print("Check requires_grad of parameter ")
    # print(model.fc1.weight.requires_grad_)   
    # print(model.fc2.weight.requires_grad_)   
    
    ### set loss  and optimizer 

    # CentropyLoss = BanknoteLoss() ### this is useless
